...
function Ho(a,b,c,d,e){var f=c._reactRootContainer;if(f){var g=f;if("function"===typeof e){var h=e;e=function(){var l=dl(g);h.call(l)}}cl(b,g,a,e)}else g=Go(c,b,a,e,d);return dl(g)}function Io(a,b){if("font"===a)return"";if("string"===typeof b)return"use-credentials"===b?b:""}var Jo=ca.Dispatcher;ca.Events=[Jb,Kb,Lb,Kc,Lc,zk];var Ko={findFiberByHostInstance:Hb,bundleType:0,version:"18.3.0-canary-be8aa7687-20231206",rendererPackageName:"react-dom"};
...
exports.useFormStatus=function(){return ea.current.useHostTransitionStatus()};exports.version="18.3.0-canary-be8aa7687-20231206";
